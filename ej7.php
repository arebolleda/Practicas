    ...
    <body>
        <div class="">
            <?php
                ...
                $sucursal_parched_1=substr($sucursal,-5,1)*9;
                //La segunda cifra de la entidad se multiplica por 7.
                $sucursal_parched_2=substr($sucursal,-6,1)*7;
                //La tercera cifra de la entidad se multiplica por 3.
                $sucursal_parched_3=substr($sucursal,-7,1)*3;
                //La cuarta cifra de la entidad se multiplica por 6.
                $sucursal_parched_4=substr($sucursal,-8,1)*6;
