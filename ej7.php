    ...
    <body>
        <div class="">
            <?php
                ...
                $banco_parched_4=substr($banco,-4,1)*10;
                ...
                $sucursal_parched_2=substr($sucursal,-4,1)*7;
                //La tercera cifra de la entidad se multiplica por 3.
                $sucursal_parched_3=substr($sucursal,-4,1)*3;
                //La cuarta cifra de la entidad se multiplica por 6.
                $sucursal_parched_4=substr($sucursal,-4,1)*6;
                ...
                //Se suman todos los resultados obtenidos.
                $total_p=$sucursal_parched_1+$sucursal_parched_2+$sucursal_parched_3+$sucursal_parched_4+$cuenta_parched_5+$cuenta_parched_6+$cuenta_parched_7+$cuenta_parched_8+$cuenta_parched_9+$cuenta_parched_10;
                //Se divide entre 11 y nos quedamos con el resto de la división.
                $total_parched2=$total_p%11;
